...
namespace Filmiy.Migrations
{
    ...
    [Migration("20251107123843_addCartToModels")]
    partial class addCartToModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Filmiy.Models.ApplicationUserOTP", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Filmiy.Models.ApplicationUserOTP", b =>
                {
                    b.HasOne("Filmiy.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Filmiy.Models.ApplicationUser", null)
                        .WithMany()
